...
{ let speedInput;
  ...
  //,calculates the demerit points and finally logs them 
    function demeriter() {
      ...
      if (demeritPoints >= 12) {
        console.log(`You've accumulated ${demeritPoints} demerit points, your license is now suspended`)
        return `You've accumulated ${demeritPoints} demerit points, your license is now suspended`;
      } else if (demeritPoints <= 11) {
        console.log(`You've accumulated ${demeritPoints} demerit points, you are ${
          12 - demeritPoints
